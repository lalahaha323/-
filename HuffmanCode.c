/*************************************************************************
	...
	> Author: 
	> Mail: 
	> Created Time: 2018年12月24日 星期一 09时47分13秒
 ************************************************************************/
#include<stdio.h>
#include<stdlib.h>
#include<string.h>
...
//编码没有传到主函数中，询问张小翔问一下怎样可以把二维数组传回去！
        ...
        else
        {
            ...
            else
            {
                while(len > READNUM)
                {
                    ...
                    {
                        int flag = str[i];
//为什么我没有输出txt文件但是为什么这里会出现？printf("%s\n",str);
                        for(j = 0; j < number; j++)
                        {
...
int main(int argc,char *argv[])
{
    ...
    Crt_HuffManCode(Tree, number, &argv[1]);//编码
